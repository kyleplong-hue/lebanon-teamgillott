        ...
        <AreaChart data={chartData} margin={{ top: 2, right: 2, left: 2, bottom: 2 }}>
          <defs>
            <linearGradient id="sparkGrad" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="#0099cc" stopOpacity={0.2} />
          ...
          <Tooltip
            content={({ active, payload }) => {
              if (active && payload && payload.length) {
                return (
                  <div className="bg-[#1a2b36] text-white text-xs px-2.5 py-1.5 rounded-lg shadow-lg">
          ...
          <Area
            ...
            fill="url(#sparkGrad)"
            dot={false}
            activeDot={{ r: 3, fill: '#0099cc', stroke: '#fff', strokeWidth: 2 }}
          />
        </AreaChart>
      </ResponsiveContainer>
    </div>
