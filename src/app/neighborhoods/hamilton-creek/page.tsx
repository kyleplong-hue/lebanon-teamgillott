...
import { HERO_HAMILTON_CREEK } from '@/data/hero-images';
  ...
  return (
    <>
      <WebPageSchema
        ...
        url={siteUrl("/neighborhoods/hamilton-creek")}
      />
      <LocalBusinessSchema
      ...
      <section
        ...
        style={{ backgroundImage: `url('${HERO_HAMILTON_CREEK}')` }}
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="flex items-baseline gap-6">
            <div>
              ...
              <div className="text-white/80 text-sm">Premium Price Range</div>
            </div>
          </div>
        </div>
      </section>
