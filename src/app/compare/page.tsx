    ...
    <>
      ...
      <section className="w-full py-16 px-4 sm:px-6 lg:px-8 bg-[#f8fafb]">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-[#1a2b36] tracking-tight mb-8 text-center">
            How to Use This Tool
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-6 border border-[#e2e8f0]">
              <div className="w-10 h-10 rounded-full bg-[#0099cc] text-white flex items-center justify-center font-bold mb-4">
                1
              </div>
              <h3 className="text-lg font-semibold text-[#1a2b36] mb-3">Select Neighborhoods</h3>
            ...
            <div className="bg-white rounded-2xl p-6 border border-[#e2e8f0]">
              ...
              <h3 className="text-lg font-semibold text-[#1a2b36] mb-3">Review the Data</h3>
              <p className="text-[#64748b] text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-6 border border-[#e2e8f0]">
              ...
              <h3 className="text-lg font-semibold text-[#1a2b36] mb-3">Make Your Choice</h3>
              <p className="text-[#64748b] text-sm leading-relaxed">
          ...
          <div className="mt-12 bg-white rounded-2xl p-8 border border-[#e2e8f0]">
            <h3 className="text-xl font-semibold text-[#1a2b36] mb-6">Understanding the Metrics</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h4 className="font-semibold text-[#1a2b36] mb-2">Price Range & Average Price</h4>
