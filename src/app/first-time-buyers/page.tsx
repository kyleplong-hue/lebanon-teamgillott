    ...
    <>
      ...
      <section className="w-full bg-white py-12 px-4 sm:px-6 lg:px-8 border-b border-gray-200">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-[#354652] mb-8 text-center font-sans">
            ...
            <table className="w-full text-center">
              <thead>
                <tr className="border-b-2 border-[#0099cc]">
                  ...
                  <th className="py-4 px-4 font-bold text-[#354652]">Median Price</th>
                  <th className="py-4 px-4 font-bold text-[#354652]">5% Down</th>
                  <th className="py-4 px-4 font-bold text-[#354652]">Est. Monthly</th>
                </tr>
              </thead>
              <tbody>
                {affordabilityComparison.map((city, idx) => (
                  <tr
                    key={idx}
                    className={`border-b ${idx % 2 === 0 ? 'bg-[#ebeff2]' : 'bg-white'}`}
                  >
                    ...
                    <td className="py-4 px-4 text-gray-700">{city.downPayment}</td>
                    <td className="py-4 px-4 text-gray-700">{city.monthlyPayment}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            {buyingSteps.map(step => (
              <div
                key={step.number}
                className="bg-white rounded-lg shadow-md p-8 border-l-4 border-[#0099cc]"
              >
                <div className="flex gap-6">
                  {/* Step Number */}
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-14 w-14 rounded-full bg-[#0099cc] text-white font-bold text-xl font-sans">
                      {step.number}
                    </div>
                  </div>
      ...
      <section className="w-full bg-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#354652] mb-4 text-center font-sans">
          ...
          <div className="space-y-8">
            {oregonPrograms.map((program, idx) => (
              <div
                key={idx}
                className="bg-[#ebeff2] rounded-lg p-8 border-l-4 border-[#0099cc]"
              >
                <div className="flex flex-col md:flex-row md:items-start md:justify-between md:gap-6 mb-4">
                  <div>
                    <h3 className="text-2xl font-bold text-[#354652] mb-2 font-sans">
                      {program.title}
                    </h3>
                  ...
                  <a
                    ...
                    className="inline-block px-6 py-2 bg-[#0099cc] text-white font-semibold rounded-lg hover:bg-[#0077aa] transition-colors duration-200 whitespace-nowrap"
                  >
                    Learn More →
                  </a>
                </div>
          ...
          <div className="mt-12 p-8 bg-yellow-50 border-l-4 border-yellow-400 rounded">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={idx} className="flex gap-3 bg-white p-4 rounded-lg">
                <div className="flex-shrink-0">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              <details
                key={idx}
                className="group bg-[#ebeff2] rounded-lg overflow-hidden border border-[#0099cc]"
              >
                <summary className="p-6 cursor-pointer hover:bg-[#dae4eb] transition-colors flex items-center justify-between">
                  <h3 className="font-bold text-[#354652] font-sans">{item.q}</h3>
